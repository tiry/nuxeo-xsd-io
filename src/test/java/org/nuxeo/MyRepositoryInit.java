...
public class MyRepositoryInit extends DefaultRepositoryInit {
    ...
    protected final DocumentModel createTestDoc(CoreSession session)
        ...
        // MC stuffs
        // ------------------------
        doc.setPropertyValue("mc:currentVersion", "V1");
        doc.setPropertyValue("mc:modelType", "Insurance");
        doc.setPropertyValue("mc:origin", "Internal");
        ...
        doc.setPropertyValue("mc:segmentVariable", (Serializable) segment);
